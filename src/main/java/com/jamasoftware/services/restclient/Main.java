...
////            JamaItem item = jamaInstance.getItem(831);
//////            System.out.println(item);
////            JamaProject project = jamaInstance.getProject(30);
////            List<JamaItem> items = project.getItems();
////            for (JamaItem jamaItem : items) {
////                System.out.println(jamaItem.getName());
////            }
//            JamaItemType story = jamaInstance.getItemType("Story");
//            System.out.println(story);
//            JamaItem item = jamaInstance.getItem(2364);
//            System.out.println(item);


            ApacheHttpClient client = new ApacheHttpClient();
            File file = new File("/Users/wikle.wang/Desktop/Jama Software.pdf");
            client.putFile("https://zhejiang.jamacloud.com/rest/v1/projects/39/attachments","wei","12345678",null,file);
